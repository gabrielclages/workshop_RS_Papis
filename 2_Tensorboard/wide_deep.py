...
# For some reason Floyd Hub refuses to accept anyother directory other than
# /output/mnist so setting it as default.
parser.add_argument(
    '--model_dir', type=str, default='/output/mnist',
    help='Base directory for the model.')

parser.add_argument(
    '--learning_rate', type=float, default=0.000001, help='Value of learning_rate')
...
parser.add_argument("--hidden_units", action=parse_comma_separated_list(element_type=int),
    default=[25], help="A list of comma seperated hidden layer sizes")
...
def build_estimator(model_dir, model_type, hidden_units, learning_rate, optimizer):
...
def main(unused_argv):
  ...
  model = build_estimator(FLAGS.model_dir, FLAGS.model_type, FLAGS.hidden_units, FLAGS.learning_rate, FLAGS.optimizer)
